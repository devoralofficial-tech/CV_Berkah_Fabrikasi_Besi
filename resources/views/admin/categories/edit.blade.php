...
@section('breadcrumb')
<a href="{{ route('admin.categories.index') }}" class="hover:text-slate-600">Kategori</a> › <span class="font-medium text-slate-700">Edit</span>
@endsection

@section('content')
<div class="max-w-lg">
    <h1 class="text-xl font-bold text-slate-800 mb-6">Edit Kategori</h1>
