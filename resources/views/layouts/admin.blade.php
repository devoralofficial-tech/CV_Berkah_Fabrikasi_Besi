        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar py-4 px-3 space-y-1">
            ...
            <div x-data="{ open: {{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.products.*') ? 'true' : 'false' }} }" class="mb-4">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-1 outline-none group">
                    <span class="text-xs font-bold uppercase tracking-[0.1em] text-slate-400 group-hover:text-slate-500 transition-colors">Produk</span>
                ...
                <div x-show="open" x-collapse>
                    <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.categories.*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.products.*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('admin.warehouse.*') ? 'true' : 'false' }} }" class="mb-4">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-1 outline-none group">
                    <span class="text-xs font-bold uppercase tracking-[0.1em] text-slate-400 group-hover:text-slate-500 transition-colors">Gudang</span>
                    <svg :class="open ? 'rotate-180' : 'rotate-0'" class="w-3.5 h-3.5 text-slate-400 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div x-show="open" x-collapse>
                    <a href="{{ route('admin.warehouse.stock-in') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.warehouse.stock-in*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.warehouse.stock-out') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.warehouse.stock-out*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.warehouse.opname-index') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.warehouse.opname*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.warehouse.low-stock') }}" class="flex items-center justify-between px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.warehouse.low-stock') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('admin.sales.*') ? 'true' : 'false' }} }" class="mb-4">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-1 outline-none group">
                    <span class="text-xs font-bold uppercase tracking-[0.1em] text-slate-400 group-hover:text-slate-500 transition-colors">Kasir</span>
                    <svg :class="open ? 'rotate-180' : 'rotate-0'" class="w-3.5 h-3.5 text-slate-400 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div x-show="open" x-collapse>
                    <a href="{{ route('admin.sales.create') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.sales.create') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.sales.index') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.sales.index') || request()->routeIs('admin.sales.show') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
            ...
            {{-- PESANAN ONLINE --}}
            <a href="{{ route('admin.orders.index') }}" class="flex items-center justify-between px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 mb-4 {{ request()->routeIs('admin.orders.*') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                <div class="flex items-center gap-3">
            ...
            <div x-data="{ open: {{ request()->routeIs('admin.reports.*') ? 'true' : 'false' }} }" class="mb-4">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-1 outline-none group">
                    <span class="text-xs font-bold uppercase tracking-[0.1em] text-slate-400 group-hover:text-slate-500 transition-colors">Laporan</span>
                    <svg :class="open ? 'rotate-180' : 'rotate-0'" class="w-3.5 h-3.5 text-slate-400 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div x-show="open" x-collapse>
                    <a href="{{ route('admin.reports.sales') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.reports.sales') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.reports.stock') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.reports.stock') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.reports.profit-loss') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.reports.profit-loss') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Laba Rugi
                    </a>
                    <a href="{{ route('admin.warehouse.low-stock') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.warehouse.low-stock') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('admin.settings.*') ? 'true' : 'false' }} }" class="mb-4">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-1 outline-none group">
                    <span class="text-xs font-bold uppercase tracking-[0.1em] text-slate-400 group-hover:text-slate-500 transition-colors">Pengaturan</span>
                    <svg :class="open ? 'rotate-180' : 'rotate-0'" class="w-3.5 h-3.5 text-slate-400 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div x-show="open" x-collapse>
                    <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.settings.index') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                    ...
                    <a href="{{ route('admin.settings.activity-log') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.settings.activity-log') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        Log Aktivitas
                    </a>
                    <a href="{{ route('admin.settings.profile') }}" class="flex items-center gap-3 px-3 py-3.5 rounded-lg font-medium text-[15px] transition-colors duration-150 {{ request()->routeIs('admin.settings.profile') ? 'bg-sky-50 text-sky-600 border-l-2 border-sky-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800 border-l-2 border-transparent' }}">
